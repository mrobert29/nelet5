...
def evaluate_lenet5(learning_rate=0.1,n_epochs=500,
    ...
    updates = [
        (param_i, param_i - learning_rate * grad_i+0.01*((param_i - learning_rate * grad_i)<0.01)-0.01*((param_i - learning_rate * grad_i)-1<0.01)+0.01*(1-(param_i - learning_rate * grad_i)<0.01))
